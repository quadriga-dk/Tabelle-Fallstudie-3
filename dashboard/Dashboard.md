...
- [4.1. Entwicklungsumgebung vorbereiten](dashboard-vorbereitung)
- [4.2. Eine Startseite für das Dashboard gestalten](landing-page)
- [4.3. Eine Karte für das Dashboard erstellen](map)
- [4.4. Einfügen Zeitverlauf](zeitverlauf)
- [4.5. Einfügen Baumstatistik](trees)
- [4.6. Einfügen Bewässerungsanalyse](watering)
