...
Dazu wird auf die Abfrage von Baumkatasterdaten der Open Educational Resource <a href="https://quadriga-dk.github.io/Tabelle-Fallstudie-2/Titelseite.html" class="external-link" target="_blank">Offene Daten im urbanen Raum</a> aufgebaut, die ebenfalls im Rahmen des Projekts <a href="https://www.quadriga-dk.de/de" class="external-link" target="_blank">QUADRIGA</a> entstanden ist. Ging es in der genannten Fallstudie noch um das Auffinden von Daten, steht in dieser Lerneinheit das Einbinden, Aufbereiten und Visualisieren von Daten im Vordergrund. Inspiriert von der Plattform <a href="https://citylab-berlin.org/de/projects/giess-den-kiez/" class="external-link" target="_blank">Gieß den Kiez</a>, einer interaktiven und kartenbasierten Plattform, die die Bewässerung von Straßenbäumen dokumentiert, wird folgende Leitfrage formuliert:
