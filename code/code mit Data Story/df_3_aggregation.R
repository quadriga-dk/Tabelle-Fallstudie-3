...
df_merged_full <- fread("data/df_baeume_final.csv", sep = ";", encoding = "UTF-8")
...
# 5. Speichern
write.csv2(df_merged_sum, file = "data/df_intervall.csv", sep = ";")
...
# # --- wetter minimieren ---
# df_wetter_monatlich_full <- read.csv("data/Wetterdaten/Filtered_Wetterdaten/combined_monthly_daten_2020_2024.csv", sep = ";", stringsAsFactors = FALSE, fileEncoding = "UTF-8")
# 
# df_wetter_monatlich <- df_wetter_monatlich_full[, c("MESS_DATUM_BEGINN", "MO_RR", "MO_TT")]
# 
# 
# write.csv2(df_wetter_monatlich, file = "data/combined_monthly_daten_2020_2024_minimal.csv")
# 
# 
# 
...
# )]
# 
# saveRDS(df, file = "data/nutzungsdatenGiessDenKiez_minimal.rds")
