...
<img src="../assets/Shiny_Icon.png" style="height:20px; width:20px; object-fit:contain; vertical-align:-4px; margin-right:4px;">
**Shiny:** <a href="https://shiny.posit.co/" class="external-link" target="_blank">Shiny</a> ist ein Open-Source-Webanwendungs-Framework, welches von RStudio und dementsprechend für die Programmiersprache R entwickelt worden ist. Das Shiny-Framework ermöglicht es R-Nutzern, ihre R-Analysen und Visualisierungen um webbasierte grafische Benutzeroberflächen (GUIs) funktional zu erweitern {cite:p}`walker_tools_2016`.
