...
![Shiny](../assets/Shiny_Icon.png) **Shiny:** <a href="https://shiny.posit.co/" class="external-link" target="_blank">Shiny</a> ist ein Open-Source-Webanwendungs-Framework, welches von RStudio und dementsprechend für die Programmiersprache R entwickelt worden ist. Das Shiny-Framework ermöglicht es R-Nutzern, ihre R-Analysen und Visualisierungen um webbasierte grafische Benutzeroberflächen (GUIs) funktional zu erweitern {cite:p}`walker_tools_2016`.
