...
Auch **Power BI** und **Tableau** bieten Interaktivität, dies jedoch innerhalb ihrer Benutzeroberflächen.  Standardmäßig sind nur Filter, Drilldowns und Highlighting-Funktionen vorhanden {cite}`walker_tools_2016`. Im Vergleich zu Shiny ist die Tiefe der Interaktivität jedoch begrenzt, da es schwieriger und komplexer ist, benutzerdefinierte Logiken umzusetzen. 
